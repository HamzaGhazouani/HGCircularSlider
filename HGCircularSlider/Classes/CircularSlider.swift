...
open class CircularSlider: UIControl {
  ...
  /**
   * The min value of circle angle
   *
   * The default value of this property is 0.
   */
  @IBInspectable
  open var circleMinValue: CGFloat = 0

  /**
   * The max value of circle angle
   *
   * The default value of this property is pi * 2.
   */
  @IBInspectable
  open var circleMaxValue: CGFloat = .pi * 2

  /**
   * The initial value of circle angle
   *
   * The default value of this property is pi / 2.
   */
  @IBInspectable
  open var circleInitialAngle: CGFloat = -(.pi / 2) {
    didSet {
  ...
  internal var startPoint: CGPoint = CGPoint(x: 0, y: 0)
  ...
  override open func draw(_ rect: CGRect) {
    ...
    let endAngle = CircularSliderHelper.scaleToAngle(circleMinValue: circleMinValue, circleMaxValue: circleMaxValue, value: endPointValue, inInterval: valuesInterval) + circleInitialAngle
  ...
  internal func newValue(from oldValue: CGFloat, touch touchPosition: CGPoint, start startPosition: CGPoint) -> CGFloat {
    ...
    let deltaValue = CircularSliderHelper.delta(circleInitialAngle: circleInitialAngle, circleMinValue: circleMinValue, circleMaxValue: circleMaxValue, in: interval, for: angle, oldValue: oldValue)
  ...
  private func resetStartPoint() {
    let startCircle = Circle(origin: bounds.center, radius: self.radius)
    startPoint = CircularSliderHelper.endPoint(fromCircle: startCircle, angle: circleInitialAngle)
  }
}
