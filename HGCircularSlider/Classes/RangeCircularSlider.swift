...
open class RangeCircularSlider: CircularSlider {
  ...
  override open func draw(_ rect: CGRect) {
    ...
    let startAngle = CircularSliderHelper.scaleToAngle(circleMinValue: circleMinValue, circleMaxValue: circleMaxValue, value: startPointValue, inInterval: interval) + circleInitialAngle
    // get end angle from end value
    let endAngle = CircularSliderHelper.scaleToAngle(circleMinValue: circleMinValue, circleMaxValue: circleMaxValue, value: endPointValue, inInterval: interval) + circleInitialAngle
